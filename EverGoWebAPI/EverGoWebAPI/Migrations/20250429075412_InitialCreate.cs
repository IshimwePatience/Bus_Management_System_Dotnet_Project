        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusNumber = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusMaintenance", x => x.MaintenanceId);
                    table.ForeignKey(
                        name: "FK_BusMaintenance_Buses_BusId",
                        column: x => x.BusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingReference = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "BusNumber",
                unique: true,
                filter: "[BusNumber] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_BusMaintenance_BusId",
